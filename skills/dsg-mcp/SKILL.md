...
metadata:
  hermes:
    tags:
      ...
      - control-plane
description: >-
  MCP server wrapper for DSG ONE control plane. Connect Claude Desktop, Cursor,
  or other MCP clients to the DSG runtime via standardized MCP protocol. Exposes
  execution gates, governance tools, agent co
---
...
### 3. Call a Tool (Example: get\_proof)
...
* [ ] Environment variables are set (DSG\_ACCESS\_TOKEN, NEXT\_PUBLIC\_APP\_URL)
...
* [docs/mcp-server/README.md](../../docs/mcp-server/) — MCP server setup and configuration
* [CLAUDE\_TOOL\_API\_CONTRACT.md](../../docs/agents/CLAUDE_TOOL_API_CONTRACT.md) — Tool API contract and boundaries
* [ENV\_SETUP\_COMPLETE.md](../../docs/ENV_SETUP_COMPLETE.md) — Environment variable reference
