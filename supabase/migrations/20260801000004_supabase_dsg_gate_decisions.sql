-- Phase 2: Z3 Formal Proof Gate Decisions Table for Supabase
-- Copied from: 20260801000003_phase2_neon_dsg_gate_decisions.sql
-- Status: Ready for Supabase production deployment
--
-- This is the Supabase equivalent of the Neon migration.
-- Schema is identical; RLS policies account for Supabase auth structure.
...
COMMENT ON TABLE dsg_gate_decisions IS
  'Phase 2 table: Z3 formal proof decisions (Supabase). Tracks deterministic gate decisions with complete proof trace.
   See docs/PHASE2_PLAN.md for verification approach and next steps.
