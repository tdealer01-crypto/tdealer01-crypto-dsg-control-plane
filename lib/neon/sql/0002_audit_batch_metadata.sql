-- Ported verbatim from supabase/migrations/20260801000002_phase2_neon_audit_batch_metadata.sql.
-- Requires lib/neon/sql/0000_auth_compat.sql and 0001_org_members.sql (get_user_orgs) first.
