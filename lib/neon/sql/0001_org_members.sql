-- Ported verbatim from supabase/migrations/20260801000001_phase2_neon_org_members.sql.
-- Requires lib/neon/sql/0000_auth_compat.sql to have been applied first
-- (defines auth.uid(), auth.role(), and roles authenticated/service_role).
-- Status: NOT APPLIED to any live database. See lib/neon/sql/0000_auth_compat.sql header.
