...
// ---------------------------------------------------------------------------
// Legacy tool-gateway types (governed tool execution path)
// Used by: audit.ts, executor.ts, policy.ts, providers.ts, tool-registry.ts,
// monitor.ts, defi-executor.ts, managed-connectors.ts, invariants/smt2.ts
// ---------------------------------------------------------------------------
