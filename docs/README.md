...
- [`PACKAGES_PRICING_MARKETPLACE_STRIPE_2026-06-20.md`](PACKAGES_PRICING_MARKETPLACE_STRIPE_2026-06-20.md) — package ladder, pricing, GitHub Marketplace positioning, Stripe product mapping, env contract, and billing launch checklist.
...
3. Read [`PACKAGES_PRICING_MARKETPLACE_STRIPE_2026-06-20.md`](PACKAGES_PRICING_MARKETPLACE_STRIPE_2026-06-20.md) before changing prices, GitHub Marketplace copy, or Stripe env values.
4. Read [`ORACLE_MCP_BROWSER_AUTOMATION_RUNBOOK_2026-06-20.md`](ORACLE_MCP_BROWSER_AUTOMATION_RUNBOOK_2026-06-20.md) before setting up or claiming Oracle-hosted MCP browser automation.
5. Read the codebase review for claim boundaries.
6. Read implemented surfaces for route and schema inspection paths.
7. Add new proof to the production evidence snapshot instead of scattering it across chat, screenshots, or ad-hoc notes.
