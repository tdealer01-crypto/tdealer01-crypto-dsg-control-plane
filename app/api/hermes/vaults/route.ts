...
import { createVault, listVaults, dispatchWebhookEvent } from '@/lib/hermes/managed-agents/store';
...
export async function GET(req: NextRequest) {
  ...
  try {
    const page = await listVaults(access.orgId, {
