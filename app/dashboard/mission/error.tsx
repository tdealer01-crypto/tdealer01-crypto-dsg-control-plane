...
export default function MissionError({
  ...
  useEffect(() => {
    console.error('[dashboard/mission] error:', error);
  }, [error]);

  return (
    <div className="mx-auto max-w-3xl px-6 py-16 text-white">
      <div className="rounded-2xl border border-red-500/30 bg-red-500/10 p-8">
        <p className="text-xs uppercase tracking-[0.2em] text-red-300">Mission Error</p>
        <h2 className="mt-4 text-2xl font-bold text-red-100">Failed to load mission</h2>
