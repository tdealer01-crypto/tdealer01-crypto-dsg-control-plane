      ...
      <section className="border-t border-white/10 px-6 py-16">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 space-y-4">
            ...
            <div className="rounded-xl border border-slate-700 bg-slate-900 p-5">
              <p className="font-bold text-white">Mutation testing — 72.08% score (Stryker)</p>
              <p className="mt-2 text-sm text-slate-400 leading-6">
                Stryker injects 265 synthetic bugs into the 4 critical modules (gate, pipeline, evidence-collector, drift-detector).
                191/265 are caught by the test suite — a 72.08% mutation score. Gated at ≥70% on every main branch merge.
                This proves the tests are not just green — they are capable of detecting real regressions.
              </p>
            </div>
          </div>
