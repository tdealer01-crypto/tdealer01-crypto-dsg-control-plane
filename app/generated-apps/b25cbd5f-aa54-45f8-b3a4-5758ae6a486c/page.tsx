...
const APP_TITLE = "DSG App Builder: Create the missing DSG agent capability: https://dsg-one-v1.vercel.app/generated";
const APP_SUMMARY = "Create the missing DSG agent capability: https://dsg-one-v1.vercel.app/generated-apps/5b5ecf71-6bdf-47a6-bd16-bdfc19a9e32e. User benefit: User gets a concrete governed action instead of a dead button.";
