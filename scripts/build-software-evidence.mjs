...
const open = Object.values(outcomes).filter((value) => value !== 'success').length;
const evidence = {
  ...
  stages: {
    ...
    benchmark: { status: status(outcomes.benchmark), required: true, provenance: 'MEASURED', evidenceHash: await hashFile('benchmark') },
  },
};
