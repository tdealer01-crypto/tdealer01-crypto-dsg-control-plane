...
<!-- Comma-separated paths, e.g. app/api/dsg/history/route.ts -->


**Blocked from doing (optional):**
<!-- Things the agent must NOT do, e.g. "Do not touch middleware.ts" -->
...
- CRITICAL: Do not import `@supabase/ssr` — it is not installed in this repo
- CRITICAL: Do not add Supabase client calls to `middleware.ts`
